...
a child, and fit in an 8 panel comic strip.
...
export const IMAGE_GEN_PROMPT = (
	finalStory: string,
	style = "",
) => `Generate an 8.5 x 11 image of a children's storybook panel consisting of
8 panels (each on 2.75 x 4) with the following story${style ? ` in the style of ${style}` : ""}.
